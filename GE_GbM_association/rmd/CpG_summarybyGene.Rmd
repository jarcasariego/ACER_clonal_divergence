...
aC <- read.delim("Genomic_features/20210120_CpGbyGeneSummary/20210120_allCpG_Count.txt",sep="\t",header=FALSE)
...
covC <- read.delim("Genomic_features/20210120_CpGbyGeneSummary/20210120_cov5CpG_Count.txt",sep="\t",header=FALSE)
...
summaryC <- read.delim("Genomic_features/20210120_CpGbyGeneSummary/20210120_cov5CpG_Summarize.txt",sep="\t",header=FALSE)
...
# Gene level summary count for all diff. methylated CpGs by treatment (all timepoints)
DML <- read.delim("Genomic_features/20210120_CpGbyGeneSummary/20210120_DML_DcDh_Count.txt",sep="\t",header=FALSE)
...
saveRDS(comb,paste0("../DML_analysis/Genomic_features/20210119_CpGbyGene_Summary/gene_CpGcoverageSummary.RData"))
