...
ggsave("../output/FigureITS2Seqs.eps", plot = its2SeqPlot, width = 8.5, height = 8.5, unit = "in", dpi = 600)
```
...
ggsave("../output/FigureITS2Profs.eps", plot = its2ProfsPlot, width = 8.5, height = 8.5, unit = "in", dpi = 600)
```
