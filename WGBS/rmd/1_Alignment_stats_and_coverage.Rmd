...
multi_bismark <- fread("data/General_Characterization/multiqc_bismark_alignment.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
multi_dedup <- fread("data/General_Characterization/multiqc_bismark_dedup.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
#general trimming stats
raw_multiqc <- fread("data/General_Characterization/multiqc_raw_general_stats.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
trim_multiqc <- fread("data/General_Characterization/multiqc_trimming_stats.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
#load metadata
meta <- readxl::read_xlsx("data/General_Characterization/Sample_Metadata.xlsx", sheet = "SampleNormalization_AllAnalyses")
...
cov_dist <- read.csv("data/General_Characterization/CpGbyCoverage.csv", header = TRUE, sep = ",")
...
jpeg("output/ACER_WGBS_mappingStat.jpg", width = 8, height= 3.5, units = "in", res = 300 )
