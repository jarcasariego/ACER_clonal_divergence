...
#plot
#jpeg("output/general_comp.DMR_genom_feat_stacked_barplot.jpg", width = 6, height = 5, units = "in", res =300)
...
```
# Found significant enrichment of CDS and Repetitive regions in DMRs responding to site
