...
dp2 <- dapc(t(dat1), coldata$site,
            n.pca = 13, n.da = 1)   # Retain 13 PCs and 1 discriminant functions
...
ggsave(filename = "output/DAPC_DMR.png", plot = dapc.fig, width = 109, height = 84.5, units = "mm")
